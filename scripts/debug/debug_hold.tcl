...
# Description : Automation component for scripts/debug/debug_hold.tcl.
# =============================================================================
...
report_if_supported report_timing [file join $d hold_detail.rpt] -delay_type min -max_paths 50 -path_type full_clock_expanded -transition_time -capacitance -nets
exit 0
